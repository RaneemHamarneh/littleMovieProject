...
//   const navigateToActors = () => {
//     router.push("/actors/Actors")
//   }
//   return (
//     <div className="sticky bg-[#000] top-0 z-[1000] flex items-center px-12 h-[72px]">
//       <Link href="/">
//         <>
//           <img
//             src="/images/White logo - no background.png"
...
//         </>
//       </Link>
//       <div className="ml-10 flex items-center space-x-4 md:space-x-8 lg:space-x-12 tracking-wide">
//         <span className="text-white cursor-pointer">
//           <span>Genres</span>
//         </span>
//         <span className="text-white">|</span>
//         <span className="text-white cursor-pointer" onClick={navigateToMovies}>
//           Movies
//         </span>
//         <span className="text-white">|</span>
//         <span className="text-white cursor-pointer" onClick={navigateToActors}>
//           Actors
//         </span>
//         <span className="text-white">|</span>
//         <a className="text-white cursor-pointer ml-auto">
